...
for update in range(30010):
    ...
    if update % 25 == 0:
        ...
        for i in range(env.num_envs):
            random_sample[i][0] = round(random.uniform(-1.0, 1.0), 1)
            random_sample[i][1] = round(random.uniform(-1.0, 1.0), 1)
            random_sample[i][2] = round(random.uniform(-1.5, 1.5), 1)
            for j in range(6):
                random_sample[i][3+j] = round(random.uniform(-1.5, 1.5), 1)
