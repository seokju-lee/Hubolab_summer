...
class RaisimGymEnv {
 ...
 public:
  ...
  float step(const Eigen::Ref<EigenVec>& action) {return rew_;};
  float stepnew(const Eigen::Ref<EigenVec>& action, float& ranval) {return rew_;};
  float stepran(const Eigen::Ref<EigenVec>& action, const Eigen::Ref<EigenVec>& ranset) {return rew_;};
  float rewards_set(int& k) {return rew_;};
 ...
 protected:
  ...
  raisim::Reward rewards_, rewards1_, rewards2_, rewards3_, rewards4_, rewards5_;
  float rew_;
};
}
