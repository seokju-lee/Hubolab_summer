...
class RaisimGymVecEnv:
    ...
    def stepnew(self, action, ranval):
        self.wrapper.stepnew(action, self._reward, self._done, ranval)
        return self._reward.copy(), self._done.copy()

    def stepran(self, action, ranset):
        self.wrapper.stepran(action, self._reward, self._done, ranset)
        return self._reward.copy(), self._done.copy()

    def rewards_set(self, i):
        self.wrapper.rewards_set(self._reward, self._done, i)
    ...
    def testob(self, ran_x, ran_y, ran_yaw, j1, j2, j3, j4, j5, j6, update_statistics=True):
        self.wrapper.testob(self._observation, update_statistics, ran_x, ran_y, ran_yaw, j1, j2, j3, j4, j5, j6)
        return self._observation
